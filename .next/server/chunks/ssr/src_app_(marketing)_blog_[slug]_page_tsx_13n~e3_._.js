module.exports=[45301,a=>{"use strict";var b=a.i(7997),c=a.i(95936);a.i(70396);var d=a.i(73727),e=a.i(72135);let f={"brent-wti-differential-q2-2025":`
...
<p>The IMO's revised GHG Strategy (October 2023) sets net-zero emissions for shipping by 2050, with a 20–30% reduction target by 2030 against a 2008 baseline. For shipping clients managing vessel fuel procurement through XRT, the strategic implication is a gradual but accelerating shift in bunker composition — with B24/B30 as a bridge fuel through 2027 before green methanol and ammonia bunkering infrastructure matures at Singaporean and major hub ports. XRT recommends establishing framework agreements for bio-blended bunker supply now, while the UCOME premium remains below $125/MT, to lock in FuelEU Maritime compliance optionality through 2026 voyage scheduling.</p>
  `};async function g(){return e.blogPosts.map(a=>({slug:a.slug}))}async function h({params:a}){let{slug:b}=await a,c=e.blogPosts.find(a=>a.slug===b);return c?{title:c.title,description:c.summary}:{}}let i={"MARKET INTELLIGENCE":"#c8111f","COMPLIANCE BRIEF":"#c8973a",REGULATORY:"#c8973a",LOGISTICS:"#c8973a","SUPPLY CHAIN":"#916f6c"};async function j({params:a}){let{slug:g}=await a,h=e.blogPosts.find(a=>a.slug===g);h||(0,d.notFound)();let k=f[g]??"",l=i[h.category]??"#c8111f",m=e.blogPosts.findIndex(a=>a.slug===g),n=m<e.blogPosts.length-1?e.blogPosts[m+1]:null,o=m>0?e.blogPosts[m-1]:null;return(0,b.jsxs)("div",{className:"bg-xrt-black min-h-screen",children:[(0,b.jsx)("section",{className:"border-b border-xrt-steel/20",children:(0,b.jsxs)("div",{className:"max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-10 sm:pb-14",children:[(0,b.jsxs)("nav",{className:"flex items-center gap-2 mb-8",children:[(0,b.jsx)(c.default,{href:"/blog",className:"label-caps text-xrt-steel/40 hover:text-xrt-steel/70 transition-colors",children:"Intelligence Hub"}),(0,b.jsx)("span",{className:"label-caps text-xrt-steel/20",children:"→"}),(0,b.jsx)("span",{className:"label-caps",style:{color:l},children:h.category})]}),(0,b.jsxs)("div",{className:"flex flex-wrap items-center gap-3 sm:gap-6 mb-8",children:[(0,b.jsx)("span",{className:"label-caps px-3 py-1.5 border",style:{color:l,borderColor:l},children:h.category}),(0,b.jsx)("span",{className:"label-caps text-xrt-steel/40",children:h.author}),(0,b.jsx)("span",{className:"label-caps text-xrt-steel/20",children:"—"}),(0,b.jsx)("span",{className:"label-caps text-xrt-steel/40",children:h.date}),(0,b.jsx)("span",{className:"label-caps text-xrt-steel/40",children:h.readTime})]}),(0,b.jsx)("h1",{className:"text-[clamp(1.8rem,5vw,3.5rem)] text-white leading-[1.05] mb-8 max-w-4xl",style:{fontFamily:"var(--font-barlow)",fontWeight:900,letterSpacing:"-0.02em",textTransform:"uppercase"},children:h.title}),(0,b.jsx)("div",{className:"w-16 h-0.5 bg-xrt-crimson"})]})}),(0,b.jsx)("section",{children:(0,b.jsx)("div",{className:"max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 py-12 sm:py-16",children:(0,b.jsxs)("div",{className:"grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12",children:[(0,b.jsxs)("article",{className:"lg:col-span-8",children:[(0,b.jsx)("div",{className:"border-l-4 border-xrt-crimson pl-6 mb-10 text-base sm:text-lg text-xrt-steel/70 leading-relaxed",style:{fontFamily:"var(--font-archivo)"},children:h.summary}),(0,b.jsx)("div",{className:"post-body",dangerouslySetInnerHTML:{__html:k}}),(0,b.jsxs)("div",{className:"mt-12 sm:mt-16 pt-8 border-t border-xrt-steel/20 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("div",{className:"label-caps text-xrt-steel/40 mb-1",children:"PUBLISHED BY"}),(0,b.jsx)("div",{className:"text-white text-sm",style:{fontFamily:"var(--font-archivo)"},children:h.author}),(0,b.jsx)("div",{className:"label-caps text-xrt-steel/30 mt-0.5",children:h.date})]}),(0,b.jsx)(c.default,{href:"/blog",className:"label-caps text-xrt-crimson border border-xrt-crimson/40 px-6 py-3 hover:border-xrt-crimson hover:bg-xrt-crimson/10 transition-colors self-start sm:self-auto",children:"← Return to Intelligence Hub"})]})]}),(0,b.jsx)("aside",{className:"lg:col-span-4",children:(0,b.jsxs)("div",{className:"sticky top-20 space-y-6",children:[(0,b.jsxs)("div",{className:"border border-xrt-steel/20 p-6",children:[(0,b.jsx)("div",{className:"label-caps text-xrt-steel/40 mb-4",children:"AUTHORED BY"}),(0,b.jsx)("div",{className:"label-caps mb-1",style:{color:l},children:h.author}),(0,b.jsx)("p",{className:"text-sm text-xrt-steel/50 leading-relaxed",style:{fontFamily:"var(--font-archivo)"},children:"XRT Group Market Intelligence — Published for institutional counterparties and procurement professionals."})]}),(0,b.jsxs)("div",{className:"border border-xrt-steel/20 p-6",children:[(0,b.jsx)("div",{className:"label-caps text-xrt-steel/40 mb-4",children:"CLASSIFICATION"}),(0,b.jsxs)("div",{className:"flex flex-wrap gap-2",children:[(0,b.jsx)("span",{className:"label-caps border border-xrt-steel/20 text-xrt-steel/60 px-3 py-1.5",children:h.category}),(0,b.jsx)("span",{className:"label-caps border border-xrt-steel/20 text-xrt-steel/60 px-3 py-1.5",children:h.readTime})]})]}),(0,b.jsxs)("div",{className:"border border-xrt-crimson/30 p-6 bg-xrt-crimson/5",children:[(0,b.jsx)("div",{className:"label-caps text-xrt-crimson mb-3",children:"READY TO ENGAGE"}),(0,b.jsx)("p",{className:"text-sm text-xrt-steel/60 leading-relaxed mb-5",style:{fontFamily:"var(--font-archivo)"},children:"XRT desks are available for direct consultation on commodity procurement strategy."}),(0,b.jsx)(c.default,{href:"/contact",className:"label-caps bg-xrt-crimson text-white px-5 py-3 hover:bg-xrt-crimson-dark transition-colors block text-center",children:"Submit RFQ"})]}),(n||o)&&(0,b.jsxs)("div",{className:"border border-xrt-steel/20 p-6 space-y-4",children:[(0,b.jsx)("div",{className:"label-caps text-xrt-steel/40 mb-3",children:"MORE DISPATCHES"}),o&&(0,b.jsxs)(c.default,{href:`/blog/${o.slug}`,className:"block group",children:[(0,b.jsx)("div",{className:"label-caps text-xrt-steel/30 mb-1",children:"NEXT"}),(0,b.jsx)("div",{className:"text-sm text-xrt-steel/70 group-hover:text-white transition-colors leading-snug",style:{fontFamily:"var(--font-barlow)",fontWeight:900,textTransform:"uppercase"},children:o.title.length>80?o.title.slice(0,80)+"…":o.title})]}),n&&(0,b.jsxs)(c.default,{href:`/blog/${n.slug}`,className:"block group",children:[(0,b.jsx)("div",{className:"label-caps text-xrt-steel/30 mb-1",children:"PREV"}),(0,b.jsx)("div",{className:"text-sm text-xrt-steel/70 group-hover:text-white transition-colors leading-snug",style:{fontFamily:"var(--font-barlow)",fontWeight:900,textTransform:"uppercase"},children:n.title.length>80?n.title.slice(0,80)+"…":n.title})]})]})]})})]})})})]})}a.s(["default",0,j,"generateMetadata",0,h,"generateStaticParams",0,g],45301)},30844,a=>{a.n(a.i(45301))}];

//# sourceMappingURL=src_app_%28marketing%29_blog_%5Bslug%5D_page_tsx_13n~e3_._.js.map