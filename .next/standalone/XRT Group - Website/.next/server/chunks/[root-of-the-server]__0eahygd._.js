...
CONTACT INFORMATION
  ...
  Email:              ${s??""}
  Commodity Interest: ${o||"(not specified)"}
...
<div class="wrap">
  ...
  <div class="body">
    ...
    <table>
      ...
      <tr><td>Commodity Interest</td><td>${l(o)||"<em>Not specified</em>"}</td></tr>
    </table>

    <div class="section-title">Message</div>
    <div class="msg">${l(n).replace(/\n/g,"<br>")}</div>
