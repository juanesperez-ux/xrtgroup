...
8:I[770419,["/_next/static/chunks/06lrirux6h8id.js","/_next/static/chunks/0wnte46uxc5yv.js","/_next/static/chunks/0xlvr.3~49eu-.js"],""]
9:I[930621,["/_next/static/chunks/06lrirux6h8id.js","/_next/static/chunks/0wnte46uxc5yv.js","/_next/static/chunks/0xlvr.3~49eu-.js"],"Image"]
d:I[885738,["/_next/static/chunks/06lrirux6h8id.js","/_next/static/chunks/0wnte46uxc5yv.js"],"OutletBoundary"]
e:"$Sreact.suspense"
3:T490,{"@context":"https://schema.org","@type":"Article","headline":"INCOTERMS 2020 for Commodity Buyers: FOB vs CIF vs DAP vs DDP","description":"Understand FOB, CIF, DAP, and DDP INCOTERMS for industrial commodity procurement. Learn how delivery terms affect risk, cost, and logistics for crude oil, fuel, and agricultural supply contracts.","datePublished":"2026-06-23","dateModified":"2026-06-23","author":{"@type":"Organization","name":"XRT Group","description":"XRT Group's commodity procurement team covering direct-origin sourcing, trade finance, inspection, logistics, and compliance across global supply chains.","url":"https://xrtgroup.com/about"},"publisher":{"@type":"Organization","name":"XRT Group","logo":{"@type":"ImageObject","url":"https://xrtgroup.com/xrt-mark.svg"}},"mainEntityOfPage":{"@type":"WebPage","@id":"https://xrtgroup.com/blog/incoterms-2020-explained-commodity-buyers"},"keywords":"INCOTERMS 2020, FOB commodity, CIF commodity, DAP supply chain, DDP procurement, commodity delivery terms, international commodity trade, procurement contracts","image":"https://xrtgroup.com/images/photo-lng-tanker-aerial.webp","articleSection":"PROCUREMENT"}4:T63c,{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Which INCOTERM is best for crude oil procurement?","acceptedAnswer":{"@type":"Answer","text":"FOB is the most common term for crude oil procurement by industrial buyers with established tanker relationships. CIF is appropriate when the buyer needs the seller to arrange vessel and insurance due to operational constraints at origin."}},{"@type":"Question","name":"Does INCOTERMS 2020 differ from INCOTERMS 2010?","acceptedAnswer":{"@type":"Answer","text":"Yes. Key changes in 2020 include: FCA now allows for on-board bills of lading under LC transactions; DPU replaces DAT; CIP now requires higher insurance coverage (Clause A) while CIF retains minimum Clause C coverage; FCA, DAP, DPU, and DDP now explicitly allow buyer or seller-arranged transport."}},{"@type":"Question","name":"Can I negotiate INCOTERMS with a supplier?","acceptedAnswer":{"@type":"Answer","text":"Yes. INCOTERMS are not mandatory — they are agreed contractually. Procurement teams can negotiate any term and can add supplemental provisions to address specific operational requirements beyond the standard INCOTERMS definition."}},{"@type":"Question","name":"What happens if the INCOTERM is not specified in the contract?","acceptedAnswer":{"@type":"Answer","text":"Absent a specified INCOTERM, courts or arbitration panels must interpret the delivery obligations under applicable law — a costly and uncertain process. Every commodity contract should specify the INCOTERM and the named place with full address precision."}}]}0:{"rsc":["$","$1","c",{"children":[[["$","$L2",null,{"id":"jsonld-article","type":"application/ld+json","dangerouslySetInnerHTML":{"__html":"$3"}}],["$","$L2",null,{"id":"jsonld-faq","type":"application/ld+json","dangerouslySetInnerHTML":{"__html":"$4"}}],["$","$L2",null,{"id":"jsonld-breadcrumb","type":"application/ld+json","dangerouslySetInnerHTML":{"__html":"{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"XRT Group\",\"item\":\"https://xrtgroup.com\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"Intelligence Hub\",\"item\":\"https://xrtgroup.com/blog\"},{\"@type\":\"ListItem\",\"position\":3,\"name\":\"INCOTERMS 2020 Explained for Commodity Buyers: FOB, CIF, DAP, and DDP\"}]}"}}],"$L5"],["$L6"],"$L7"]}],"isPartial":false,"staleTime":300,"varyParams":null,"buildId":"1lMmnSQiqBwTi1YobFR0T"}
a:T2e61,
...
<p><strong>Questions about structuring your commodity supply agreement?</strong> Contact our procurement desk at <a href="mailto:procurement@xrtgroup.com">procurement@xrtgroup.com</a> or submit an RFQ through our <a href="/contact">procurement portal</a>.</p>
  5:["$","div",null,{"className":"bg-xrt-off-white min-h-screen","children":[["$","section",null,{"className":"bg-xrt-black text-white border-b border-xrt-steel/20","children":["$","div",null,{"className":"max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-16 pb-10 sm:pb-14","children":[["$","nav",null,{"className":"flex items-center gap-2 mb-8","aria-label":"Breadcrumb","children":[["$","$L8",null,{"href":"/blog","className":"label-caps text-xrt-steel/40 hover:text-xrt-steel/70 transition-colors","children":"Intelligence Hub"}],["$","span",null,{"className":"label-caps text-xrt-steel/20","children":"→"}],["$","span",null,{"className":"label-caps","style":{"color":"#c8111f"},"children":"PROCUREMENT"}]]}],["$","div",null,{"className":"flex flex-wrap items-center gap-3 sm:gap-6 mb-8","children":[["$","span",null,{"className":"label-caps px-3 py-1.5 border","style":{"color":"#ffffff","borderColor":"#c8111f","backgroundColor":"#c8111f33"},"children":"PROCUREMENT"}],["$","span",null,{"className":"label-caps text-xrt-steel/40","children":"XRT Group"}],["$","span",null,{"className":"label-caps text-xrt-steel/20","children":"—"}],["$","time",null,{"className":"label-caps text-xrt-steel/40","dateTime":"2026-06-23","children":"June 23, 2026"}],["$","span",null,{"className":"label-caps text-xrt-steel/40","children":"12 MIN READ"}]]}],["$","h1",null,{"className":"text-[clamp(1.8rem,5vw,3.5rem)] text-white leading-[1.05] mb-8 max-w-4xl","style":{"fontFamily":"var(--font-barlow)","fontWeight":900,"letterSpacing":"-0.02em","textTransform":"uppercase"},"children":"INCOTERMS 2020 Explained for Commodity Buyers: FOB, CIF, DAP, and DDP"}],["$","div",null,{"className":"relative mt-8 min-h-[260px] overflow-hidden sm:min-h-[360px] lg:min-h-[460px]","children":[["$","$L9",null,{"src":"/images/photo-lng-tanker-aerial.webp","alt":"INCOTERMS 2020 Explained for Commodity Buyers: FOB, CIF, DAP, and DDP","fill":true,"priority":true,"sizes":"(max-width: 1024px) 100vw, 90vw","className":"object-cover"}],["$","div",null,{"className":"absolute inset-0 bg-gradient-to-t from-xrt-black/60 via-transparent to-transparent"}]]}]]}]}],["$","section",null,{"className":"bg-xrt-white","children":["$","div",null,{"className":"max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 py-12 sm:py-16","children":["$","div",null,{"className":"grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12","children":[["$","article",null,{"className":"lg:col-span-8","children":[["$","div",null,{"className":"border-l-4 border-xrt-crimson pl-6 mb-10 text-base sm:text-lg text-xrt-muted leading-relaxed","style":{"fontFamily":"var(--font-archivo)"},"children":"A practical breakdown of INCOTERMS 2020 for procurement directors sourcing crude oil, diesel, agricultural commodities, and edible oils. Understand what FOB, CIF, DAP, and DDP mean for your risk, cost, and logistics structure."}],["$","div",null,{"className":"post-body","dangerouslySetInnerHTML":{"__html":"$a"}}],"$Lb"]}],"$Lc"]}]}]}]]}]
6:["$","script","script-0",{"src":"/_next/static/chunks/0xlvr.3~49eu-.js","async":true}]
7:["$","$Ld",null,{"children":["$","$e",null,{"name":"Next.MetadataOutlet","children":"$@f"}]}]
b:["$","div",null,{"className":"mt-12 sm:mt-16 pt-8 border-t border-xrt-steel flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6","children":[["$","div",null,{"children":[["$","div",null,{"className":"label-caps text-xrt-muted/60 mb-1","children":"PUBLISHED BY"}],["$","div",null,{"className":"text-xrt-near-black text-sm","style":{"fontFamily":"var(--font-archivo)"},"children":"XRT Group"}],["$","time",null,{"className":"label-caps text-xrt-muted/60 mt-0.5 block","dateTime":"2026-06-23","children":"June 23, 2026"}]]}],["$","$L8",null,{"href":"/blog","className":"label-caps text-xrt-crimson border border-xrt-crimson/30 px-6 py-3 hover:bg-xrt-crimson/5 transition-colors self-start sm:self-auto","children":"← Return to Intelligence Hub"}]]}]
c:["$","aside",null,{"className":"lg:col-span-4","children":["$","div",null,{"className":"sticky top-20 space-y-6","children":[["$","div",null,{"className":"border border-xrt-steel bg-xrt-surface-low p-6","children":[["$","div",null,{"className":"label-caps text-xrt-muted/60 mb-4","children":"AUTHORED BY"}],["$","div",null,{"className":"label-caps mb-1 text-xrt-near-black","style":{"color":"#c8111f"},"children":"XRT Group"}],["$","p",null,{"className":"text-sm text-xrt-muted leading-relaxed","style":{"fontFamily":"var(--font-archivo)"},"children":"XRT Group Market Intelligence — Published for institutional counterparties and procurement professionals."}]]}],["$","div",null,{"className":"border border-xrt-steel bg-xrt-surface-low p-6","children":[["$","div",null,{"className":"label-caps text-xrt-muted/60 mb-4","children":"CLASSIFICATION"}],["$","div",null,{"className":"flex flex-wrap gap-2","children":[["$","span",null,{"className":"label-caps border border-xrt-steel text-xrt-muted px-3 py-1.5","children":"PROCUREMENT"}],[["$","span","INCOTERMS",{"className":"label-caps border border-xrt-steel text-xrt-muted px-3 py-1.5","children":"INCOTERMS"}],["$","span","INCOTERMS 2020",{"className":"label-caps border border-xrt-steel text-xrt-muted px-3 py-1.5","children":"INCOTERMS 2020"}],["$","span","commodity procurement",{"className":"label-caps border border-xrt-steel text-xrt-muted px-3 py-1.5","children":"commodity procurement"}]],["$","span",null,{"className":"label-caps border border-xrt-steel text-xrt-muted px-3 py-1.5","children":"12 MIN READ"}]]}]]}],["$","div",null,{"className":"border border-xrt-crimson/30 bg-xrt-crimson/5 p-6","children":[["$","div",null,{"className":"label-caps text-xrt-crimson mb-3","children":"Ready to initiate a procurement discussion?"}],["$","p",null,{"className":"text-sm text-xrt-muted leading-relaxed mb-5","style":{"fontFamily":"var(--font-archivo)"},"children":"XRT desks are available for direct consultation on commodity procurement strategy."}],["$","$L8",null,{"href":"/rfq","className":"label-caps bg-xrt-crimson text-white px-5 py-3 hover:bg-xrt-crimson-dark transition-colors block text-center","children":"Submit an RFQ"}]]}],["$","div",null,{"className":"border border-xrt-steel bg-xrt-surface-low p-6 space-y-4","children":[["$","div",null,{"className":"label-caps text-xrt-muted/60 mb-3","children":"MORE DISPATCHES"}],["$","$L8",null,{"href":"/blog/how-to-source-commodities-for-industrial-operations","className":"block group","children":[["$","div",null,{"className":"label-caps text-xrt-muted/40 mb-1","children":"NEXT"}],["$","div",null,{"className":"text-sm text-xrt-muted group-hover:text-xrt-near-black transition-colors leading-snug","style":{"fontFamily":"var(--font-barlow)","fontWeight":900,"textTransform":"uppercase"},"children":"How to Source Commodities for Industrial Operations: A Procurement Director's Gu…"}]]}],["$","$L8",null,{"href":"/blog/crude-oil-refined-fuel-procurement-guide","className":"block group","children":[["$","div",null,{"className":"label-caps text-xrt-muted/40 mb-1","children":"PREV"}],["$","div",null,{"className":"text-sm text-xrt-muted group-hover:text-xrt-near-black transition-colors leading-snug","style":{"fontFamily":"var(--font-barlow)","fontWeight":900,"textTransform":"uppercase"},"children":"Crude Oil and Refined Fuel Procurement: What Industrial Buyers Need to Know"}]]}]]}]]}]}]
f:null
